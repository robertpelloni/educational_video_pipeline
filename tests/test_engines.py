...
from src.video_engine import compile_video, MissingAssetError
...
def test_compile_video_logic(mock_exists, mock_image_clip, mock_audio_clip):
    ...
    with patch("src.video_engine.concatenate_videoclips") as mock_concat, \
        ...
        # Verify volumex is called with the target volume 0.15
        assert mock_volumex.call_args[0][1] == 0.15
